...
-- INSERT INTO public.teams (team_name, team_size, score, on_route, reg_date) VALUES ('zer0points', 3, 75, true, '2021-11-04');
-- INSERT INTO public.teams (team_name, team_size, score, on_route, reg_date) VALUES ('flagbots', 3, 30, false, '2021-11-04');
-- INSERT INTO public.teams (team_name, team_size, score, on_route, reg_date) VALUES ('over9000', 3, 15, false, '2021-11-05');
-- INSERT INTO public.teams (team_name, team_size, score, on_route, reg_date) VALUES ('decrypters', 5, 60, false, '2021-11-11');
-- INSERT INTO public.teams (team_name, team_size, score, on_route, reg_date) VALUES ('qword', 5, 45, false, '2021-11-12');
-- INSERT INTO public.teams (team_name, team_size, score, on_route, reg_date) VALUES ('s3quence', 5, 30, false, '2021-11-13');
-- INSERT INTO public.teams (team_name, team_size, score, on_route, reg_date) VALUES ('redcode', 7, 15, false, '2021-11-15');
-- INSERT INTO public.teams (team_name, team_size, score, on_route, reg_date) VALUES ('watershell', 7, 60, false, '2021-11-18');
-- INSERT INTO public.teams (team_name, team_size, score, on_route, reg_date) VALUES ('h4ckers', 7, 45, false, '2021-11-19');
...
-- INSERT INTO teams_tasks values (1, 1, true), (1, 2, true), (1, 3, true), (1, 4, true), (1, 5, true);
